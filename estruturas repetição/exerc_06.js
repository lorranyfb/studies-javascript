...
let contador = 0;
let encontrouHabilitado = false; // variável boolena para indicar se o func foi encontrado 

while ( contador < funcionarios.length ) {

    let funcionario = funcionarios[contador];

    if( funcionario.habilitado == true ){ //se um func tiver a propriedade habilidado com valor true, o loop será interrompido pelo comando break
...
if (!encontrouHabilitado) {  //caso o valor seja falso
